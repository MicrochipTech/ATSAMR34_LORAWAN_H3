/**
* \file  lorawan_reg_params.h
*
* \brief Lorawan Regional Parameters header
*		
*
*/
/*******************************************************************************
...
#define NUMBER_CFLIST_CHMASK				5
/* CFList contains CHMask for 72 channels */
#define CFLIST_TYPE_1						0x01
/* CFList Contains Frequency list for 5 channels */
#define CFLIST_TYPE_0						0x00
