...
#define DR0_PARAMS_EU                          {  8,  59,   0,  -33,  12,  BW_125KHZ,     MODULATION_LORA}
#define DR1_PARAMS_EU                          { 11,  59,   0,  -45,  11,  BW_125KHZ,     MODULATION_LORA}
#define DR2_PARAMS_EU                          { 29,  59,   0,  -58,  10,  BW_125KHZ,     MODULATION_LORA}
#define DR3_PARAMS_EU                          { 28, 123,   0,  -62,   9,  BW_125KHZ,     MODULATION_LORA}
#define DR4_PARAMS_EU                          { 61, 250,   0,  -66,   8,  BW_125KHZ,     MODULATION_LORA}
#define DR5_PARAMS_EU                          { 83, 250,   0,  -68,   7,  BW_125KHZ,     MODULATION_LORA}
