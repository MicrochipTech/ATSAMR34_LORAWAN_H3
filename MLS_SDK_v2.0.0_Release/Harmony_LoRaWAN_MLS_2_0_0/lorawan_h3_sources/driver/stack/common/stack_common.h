...
#define BUILD_TYPE_PRODUCTION     1
#define BUILD_TYPE_RELCANDIDATE   2
#define BUILD_TYPE_RESERVED       3
...
#if (BUILD_TYPE == BUILD_TYPE_PRODUCTION)
#define STACK_VER   "MLS v"MAJOR_NUM"."MINOR_NUM"."PATCH_NUM
#elif (BUILD_TYPE == BUILD_TYPE_RELCANDIDATE)
#define STACK_VER   "MLS v"MAJOR_NUM"."MINOR_NUM"."PATCH_NUM"-rc."RC_NUM
#else
#error "STACK_VER invalid"
#endif
...
Example:
 ...
 Reserved  stack  stack  qual. iteration    Reserved
           major  minor
******************************************************************************/
#define STACK_VERSION_VALUE      (0x02040000)
